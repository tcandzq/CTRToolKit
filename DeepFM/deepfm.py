#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2019/9/11 11:34
# @Author  : tc
# @File    : deepfm.py.py

"""
代码参考:https://github.com/Johnson0722/CTR_Prediction
"""
...
class DeepFM(object):
    ...
    def __init__(self, config):
        ...
        self.reg_l1 = config['reg_l1']  # L1正则化
        self.reg_l2 = config['reg_l2']  # L2正则化
        # num of features
        self.p = feature_length  # 特征维度
        # num of fields
        self.field_cnt = field_cnt  # 特征的数量
